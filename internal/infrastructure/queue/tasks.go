...
//
// StrategyData is opaque JSON — the handler decodes it via the
// same serialise helpers the persistence layer uses, which keeps
// the queue package free of domain-specific unmarshal logic.
