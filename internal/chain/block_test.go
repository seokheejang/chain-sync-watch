...
func TestBlockNumber_Uint64(t *testing.T) {
	...
	require.Equal(t, uint64(16_777_216), chain.NewBlockNumber(16_777_216).Uint64())
}
...
func TestBlockNumber_UnmarshalJSON_AcceptsNumberAndHex(t *testing.T) {
	cases := []struct {
		...
		{"zero number", `0`, 0},
		{"big decimal number", `16777216`, 16_777_216},
		{"hex lowercase", `"0xa"`, 10},
		{"hex uppercase", `"0xA"`, 10},
		{"hex zero", `"0x0"`, 0},
		{"hex big", `"0x1000000"`, 16_777_216},
...
func TestBlockNumber_JSON_RoundTrip(t *testing.T) {
	for _, n := range []uint64{0, 1, 10, 255, 16_777_216, 1<<63 - 1} {
